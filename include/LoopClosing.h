...
public:
    ...
    // Used by System::Shutdown after the loop-closing worker has stopped.
    // It aborts a pending global BA and waits for it to finish.
    void WaitForGlobalBundleAdjustment();
