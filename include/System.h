...
public:
    ...
    // Save all valid MapPoints from the active map as an ASCII PLY point cloud.
    // Call first Shutdown(). Returns the number of exported points.
    std::size_t SaveMapPointsPLY(const string &filename);
