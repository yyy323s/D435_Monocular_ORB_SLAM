...
//BOOST_CLASS_EXPORT_GUID(Pinhole, "Pinhole")
    ...
    bool Pinhole::epipolarConstrain(GeometricCamera* pCamera2,  const cv::KeyPoint &kp1, const cv::KeyPoint &kp2, const Eigen::Matrix3f& R12, const Eigen::Vector3f& t12, const float sigmaLevel, const float unc) {//极线约束
    ...
    {
        if(pCam->GetType() != GeometricCamera::CAM_PINHOLE)//是不是针孔
            return false;

        Pinhole* pPinholeCam = (Pinhole*) pCam;//子类Pinhole
